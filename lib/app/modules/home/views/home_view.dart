                ...
                children: [
                  InAppWebView(
                    ...
                    initialUrlRequest: URLRequest(
                        url: WebUri(
                            "http://lifeapp.maklife.in:8085/Login/Check_Login/${controller.mobileNumber.toString()}")),
                    ...
                    shouldOverrideUrlLoading: (cx, navigationAction) async {
                      const platform = MethodChannel("com.MAK_LIFE_APP/play");

                      const platform1 = MethodChannel("com.MAK_LIFE_APP/upi");

                      // "com.maklife.mak_diary/intent"

                      const platform2 =
                          MethodChannel("com.MAK_LIFE_APP/intent");

                      // com.genmak.maklifedairy/upi
                      const platform3 = MethodChannel("com.MAK_LIFE_APP/upi");
                      ...
                      if (uri != null && uri.scheme == "store") {
                        ...
                        try {
                          if (Platform.isAndroid) {
                            final bool handled = await platform.invokeMethod(
                                "handlePlayUrl", {"url": storeUrl});
                            if (handled) {
                    ...
                    onDownloadStartRequest: (cx, request) async {
                      ScaffoldMessenger.of(Get.context!)
                        ...
                        content:
                            Text("Downloading is in progress please wait!"),
                      ));
